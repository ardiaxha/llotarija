...
contract Lottery {
    ...
    uint256 public constant duration = 43200 minutes; // The duration set for the lottery
    ...
    address public biggestPrize;
    uint256 public biggestPrizeAmmount;
    uint256 public bonticket = 0.009 ether;
    uint256 public bonticket2 = 0.006 ether;
    ...
    function BuyTicketsBonus() public payable {
        ticketPrice = 0.009 ether;
        require(
            msg.value % ticketPrice == 0,
            string.concat(
                "the value must be multiple of ",
        ...
        require(
            numOfTicketsToBuy == 3,
            "You can only get 3 tickets at a time with this offer"
        );
        ...
        function BuyTicketsBonus2() public payable {
        ticketPrice = 0.006 ether;
        require(
            msg.value % ticketPrice == 0,
            string.concat(
                "the value must be multiple of ",
        ...
        require(
            numOfTicketsToBuy == 5,
            "You can only get 5 tickets at a time with this offer"
        );
...
function BuyTicketsBonus3() public payable {
        require(
            msg.value % ticketPrice == 0,
            string.concat(
                "the value must be multiple of ",
        ...
        require(
            numOfTicketsToBuy == 7,
            "You can only get 7 tickets at a time with this offer"
        );
